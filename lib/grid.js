...
function getNeighborsValueWithCondition(x, y, condition) {
  var neighbors = [
    //orth
    x > 0 ? [x - 1, y, grid[x - 1][y]] : null,
    x < grid.length - 1 ? [x + 1, y, grid[x + 1][y]] : null,
    y > 0 ? [x, y - 1, grid[x][y - 1]] : null,
    y < grid[0].length - 1 ? [x, y + 1, grid[x][y + 1]] : null,
    //diag
    x > 0 && y > 0 ? [x - 1, y - 1, grid[x - 1][y - 1]] : null,
    x > 0 && y < grid[0].length - 1 ? [x - 1, y + 1, grid[x - 1][y + 1]] : null,
    x < grid.length - 1 && y > 0 ? [x + 1, y - 1, grid[x + 1][y - 1]] : null,
